...
[x] Have punch aquire its targets ("Target Lock") at the start of the use.  Have it highlight enemies with the preview to indicate this.
...
- Revisit "ghost previews" of other people's unsubmitted abilities.  We should also show them on the timeline.
