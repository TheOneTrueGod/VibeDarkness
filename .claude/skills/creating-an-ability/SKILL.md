...
**Combat hit discovery** — Shape damage/CC must go through a hitbox or a helper that wraps one (see **Hitboxes (combat)** in the full guide and `hitboxes/SKILL.md`). Do not hand-roll enemy radius loops for combat.
