...
export const miscTree: ResearchTreeDef = {
    id: MISC_TREE_ID,
    title: 'Lightbearer',
    accessRequirements: [{ type: 'anyResearched', treeId: MISC_TREE_ID, nodeIds: [MISC_NODE_LIGHTBEARER, MISC_NODE_BEAST_CORE, MISC_NODE_AIR_CORE, MISC_NODE_CHARGED_CORE, MISC_NODE_BLINK_CORE] }],
    nodes: [
        {
