...
export default function Chat({ messages, connectionStatus, enabled, onSend }: ChatProps) {
    ...
    return (
        <div className="w-80 bg-surface flex flex-col border-l border-border-custom max-md:w-full max-md:h-[300px] max-md:border-l-0 max-md:border-t max-md:border-border-custom">
            {/* Header */}
            ...
            {/* Input */}
            <div className="flex gap-2 p-4 border-t border-border-custom">
                <input
                    type="text"
