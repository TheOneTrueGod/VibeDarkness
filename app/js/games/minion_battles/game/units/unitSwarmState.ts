...
export function swarmStateToJSON(unit: Unit): Record<string, unknown> {
    return {
        ...
        ...(unit.swarmState.nestSpawnState != null
            ...
            : {}),
        ...(unit.swarmState.nestHomePoiId != null ? { swarmNestHomePoiId: unit.swarmState.nestHomePoiId } : {}),
...
export function applySwarmStateFromJSON(unit: Unit, data: Record<string, unknown>): void {
    ...
    if (typeof data.swarmNestHomePoiId === 'string') {
        unit.swarmState.nestHomePoiId = data.swarmNestHomePoiId;
    }
