...
export const MAP_SEGMENT_50_49_CLIFF_PATH_NORTH: TerrainType[][] = [
    ...
    [R, T, _, _, R, _, D, D, T, T, _, _, R, _, _, _, _, _, _, _, R, R],
    [R, _, _, R, R, _, D, D, _, _, _, R, R, _, _, _, _, _, _, R, R, R],
    [R, _, _, R, R, _, _, D, D, _, _, _, _, _, _, _, _, _, R, R, R, R],
    [R, _, T, _, _, _, _, D, D, T, T, _, _, _, _, _, _, R, R, R, R, R],
    [R, T, T, T, _, _, _, D, D, T, T, T, _, _, _, _, _, R, R, R, R, R],
    [R, _, _, _, _, _, _, _, D, D, _, _, _, _, _, _, R, R, R, R, R, R],
    [R, _, R, _, _, _, _, _, D, D, _, _, _, _, _, R, R, R, R, R, R, R],
    ...
    [R, R, R, R, R, R, R, R, R, _, D, D, _, _, R, R, R, R, R, R, R, R],
];
...
/** Firelight campfires along the cliff path (segment-local). */
export const campfire_south: PointOfInterest = { row: 21, col: 8 };
export const campfire_mid: PointOfInterest = { row: 13, col: 14 };
...
/** Ordered campfire POIs for mission special-tile placement. */
export const CLIFF_PATH_CAMPFIRE_POINTS = [campfire_south, campfire_mid] as const;
