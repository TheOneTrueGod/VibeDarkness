...
import { EARTH_CORE_RESONANCE_GAIN_ON_OWN_ARMOUR_BREAK } from '../../constants/earthCoreConstants';
import { getEarthCoreArmour } from '../0600_EarthCoreShared/earthCoreArmour';

const ABILITY_ID = '0601_fault_harvest';
...
export const FaultHarvestCard: CardDef = {
    id: asCardDefId('0601_fault_harvest'),
    name: 'Fault Harvest',
