...
import { getEarthCoreArmour, spendAllEarthCoreArmour } from '../0600_EarthCoreShared/earthCoreArmour';
import { asCardDefId, type CardDef } from '../types';

const ABILITY_ID = '0606_stoney_punch';
const BASE_DAMAGE = 4;
...
export const StoneyPunchCard: CardDef = {
    id: asCardDefId('0606_stoney_punch'),
    name: 'Stoney Punch',
