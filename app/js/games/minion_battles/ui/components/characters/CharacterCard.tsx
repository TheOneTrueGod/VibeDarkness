...
import { characterCardTestId } from '../../../../../testing/testIds';
...
export function CharacterCard({
    ...
    const displayName = character.name?.trim() || 'Unnamed';
    return (
        <div
            ...
            data-testid={characterCardTestId(character.id)}
        ...
        >
            <div className="flex items-center w-full">
                <button
                    ...
                    className="flex-1 min-w-0 px-4 py-3 text-left hover:bg-white/5 transition-colors rounded-lg"
                >
                    <div className="flex items-center gap-3">
                        {portrait?.picture && (
                            <div className="h-10 w-10 shrink-0 rounded-full border border-border-custom overflow-hidden bg-dark-700" aria-hidden="true">
                ...
                {!confirming && (
                    <button
                        ...
                        className="shrink-0 p-1 mr-3 rounded text-zinc-500 hover:text-red-400 hover:bg-red-950/30 transition-colors cursor-pointer"
