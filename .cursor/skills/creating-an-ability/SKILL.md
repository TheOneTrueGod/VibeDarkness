...
**See `app/js/games/minion_battles/card_defs/SKILL.md` for the full guide** (including **`abilityTimings` half-open intervals**, stable `id` conventions, **`AbilityGroupId` / skill-tree folders** (e.g. `earth_core/`, `utility/`)).
