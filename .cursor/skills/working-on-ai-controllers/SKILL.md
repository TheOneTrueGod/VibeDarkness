...
- **unitAITreeId** on Unit: `'default'` or `'alphaWolfBoss'`. Set when spawning from mission `aiController`.
...
- **Mission aiController**: Maps to tree — `'alphaWolfBoss'` → alphaWolfBoss tree, else → default tree.
